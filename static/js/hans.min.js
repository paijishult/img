...
function (e, n, o) {
    ...
    e.console && console.warn, F in P || (F = "src"), $["image/jpeg"] = !0, $["image/gif"] = !0, $["image/png"] = !0, $["image/svg+xml"] = n.implementation.hasFeature("https://www.w3.org/TR/SVG11/feature#Image", "1.1"), R.ns = ("pf" + (new Date).getTime()).substr(0, 9), R.supSrcset = "srcset" in P, R.supSizes = "sizes" in P, R.supPicture = !!e.HTMLPictureElement, R.supSrcset && R.supPicture && !R.supSizes && (y = n.createElement("img"), P.srcset = "data:,a", y.src = "data:,a", R.supSrcset = P.complete === y.complete, R.supPicture = R.supSrcset && R.supPicture), R.supSrcset && !R.supSizes ? (w = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", S = n.createElement("img"), x = function () {
...
function (i, n) {
    ...
    return i.updateGetPathSelector = function (t) {
        ...
        var t = this.getPath();
        if (t.match(/^https/) || t.match(/^\//)) this.getAbsolutePath = this.getPath;
        else {
